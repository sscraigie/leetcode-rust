 ...
 * The signal quality of the i^th tower at a coordinate (x, y) is calculated with the formula &lfloor;qi / (1 + d)&rfloor;, where d is the distance between the tower and the coordinate. The network quality at a coordinate is the sum of the signal qualities from all the reachable towers.
...
// discuss: https://leetcode.com/problems/coordinate-with-maximum-network-quality/discuss/?currentPage=1&orderBy=most_votes&query=
