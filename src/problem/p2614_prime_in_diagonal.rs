 ...
 * 	1 <= nums<span style="font-size: 10.8333px;">[i][j]</span> <= 4*10^6
 * 
 */
pub struct Solution {}

// problem: https://leetcode.com/problems/prime-in-diagonal/
// discuss: https://leetcode.com/problems/prime-in-diagonal/discuss/?currentPage=1&orderBy=most_votes&query=
